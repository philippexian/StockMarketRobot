...
#from data_model import StockDataSet #TODO define a class StockDataSet
from trainingExample import LstmRNN
...
def load_sp500(input_size, num_steps, k=None, target_symbol=None, test_ratio=0.05):
   ...
   info = pd.read_csv("data/constituents-financials.csv") #must prepare a sp 500 file
